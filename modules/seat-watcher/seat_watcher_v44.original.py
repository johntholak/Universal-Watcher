...
def build_dynamic_amc_url(slug):
    # AMC currently accepts the "undefined" market segment for direct
    # showtime routes. This avoids having to know AMC's internal market
    # name for every city.
    return (
        "https://www.amctheatres.com/"
        ...
        try:
            while True:
                ...
                if kind == "log":
                    ...
                    if self.status_text.get() != "SEATS FOUND":
                        self.status_text.set(value)
